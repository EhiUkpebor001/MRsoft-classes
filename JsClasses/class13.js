        ...
        WAYS OF CREATING AN OBJECT
            ...
            3) Creating an object using the Constructor function:
                ...
                SYNTAX:
                    ...
                    let objectName1 = new customObjectName ("argument1", "argument2", "argument3");
                    let objectName2 = new customObjectName ("argument1", "argument2", "argument3");
...
console.log(student.isRegistered);  // The output is 'undefined' because we've deleted the 'isRegistered' property for the STUDENT object in line 65.
console.log("\n", car);
console.log("\n", car.name);
console.log("\n", car["color"]);
car.drive();
